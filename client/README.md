...
In the branch UpdateContext, you can not only read values from context, but update the global application state from the child component by using a function provided by the context.
